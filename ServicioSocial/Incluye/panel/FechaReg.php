...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['FechaIni']) && isset($_POST['FechaFin'])) {
    ...
    if ($fechaFin <= $fechaIni) {
        ...
        $checkQuery = "SELECT Id FROM fecha_registro WHERE tipo = 'formulario'";
        $checkResult = mysqli_query($enlace, $checkQuery);
        
        if (mysqli_num_rows($checkResult) > 0) {
            // Actualizar registro existente
            $updateQuery = "UPDATE fecha_registro SET Fecha_In = ?, Fecha_Fin = ? WHERE tipo = 'formulario'";
            ...
            $insertQuery = "INSERT INTO fecha_registro (Fecha_In, Fecha_Fin, tipo) VALUES (?, ?, 'formulario')";
...
// Consultar fechas existentes con tipo 'formulario'
$query = "SELECT * FROM fecha_registro WHERE tipo = 'formulario' LIMIT 1";
            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-edit"></i> Configuración de Período de Registro
                    </div>
                    <div class="card-body">
                        <form method="post" id="fechasForm">
                            <div class="form-section">
                                <h4><i class="fas fa-play-circle text-success"></i> Fecha de Inicio</h4>
                                <p class="text-muted mb-3">Establece cuándo comenzará el período de registro</p>
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div class="form-section">
                                ...
                                <p class="text-muted mb-3">Establece cuándo finalizará el período de registro</p>
                                <div class="row">
                                    <div class="col-md-6">
